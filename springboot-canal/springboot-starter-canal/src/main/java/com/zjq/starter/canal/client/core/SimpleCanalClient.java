...
import com.zjq.starter.canal.client.abstracts.AbstractCanalClient;
 ...
 *
 * @author
 * @created 2020/5/28 14:52
 * @Modified_By 阿导 2020/5/28 14:52
 */
public class SimpleCanalClient extends AbstractCanalClient {
    ...
    private void initListeners() {
        ...
        //若是你喜欢通过注解的方式去监听的话。。
        Map<String, Object> listenerMap = BeanUtil.getBeansWithAnnotation(com.zjq.starter.canal.annotation.CanalEventListener.class);
        //也放入 map
        if (listenerMap != null) {
