...
CREATE TABLE sys_job (
                         ...
                         update_time TIMESTAMP NOT NULL default CURRENT_TIMESTAMP -- 假设更新时间在更新记录时自动更新
);
...
CREATE TABLE sys_job_log(
                            ...
                            time TIMESTAMP DEFAULT NULL,            -- time字段可以改为DATETIME以存储具体的时间点
                            status INTEGER NOT NULL DEFAULT 0,  -- 执行状态，使用TINYINT(1)来存储0或1
                            exception_info TEXT DEFAULT NULL,       -- 异常信息，使用TEXT类型来存储可能较长的文本
                            create_time TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP
)  ;  -- 使用InnoDB引擎和utf8mb4字符集

CREATE INDEX idx_task_id
    ON sys_job_log (task_id);
